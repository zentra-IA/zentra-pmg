...
export async function POST(req: NextRequest, context: Context) {
  try {
    ...
    /*
     * Segurança multiempresa e multiusuário:
     * a sessão final é calculada no servidor usando a empresa e o usuário
     * autenticados. O navegador nunca informa o fullSessionId diretamente.
     */
