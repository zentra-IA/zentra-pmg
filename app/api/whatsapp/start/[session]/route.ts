...
export async function POST(req: NextRequest, context: Context) {
  try {
    ...
    /*
     * Segurança multiempresa/multiusuário:
     * a sessão final é sempre resolvida no servidor com base
     * na empresa e no usuário autenticados.
     *
     * Nunca aceitamos fullSessionId enviado pelo navegador.
     */
      ...
      return NextResponse.json(
        {
          ...
          error: isTimeoutError(error)
            ? "Servidor do WhatsApp demorou para iniciar a sessão."
    ...
    return NextResponse.json(
      {
         ...
         * Esse valor é sempre gerado no servidor.
         */
        finalSessionId,
      },
      {
